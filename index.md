...
- 꾸준한 노력을 통한 장기적인 저의 계획은 Python 및 아마존 AWS, Python anaconda(웹 크롤링) 등을 지속적으로 공부하여 백엔드 개발자 출신의 머신러닝 엔지니어가 되는 것을 목표로 하고 있습니다. 취업을 하고 업무 수행에 큰 무리가 없을 정도의 실력이 되는 것을 단˙중기 목표로 할 것입니다. 그 후 AWS SAA 시험을 시작으로 머신러닝 엔지니어가 되기 위한 공부를 시작할 것입니다.
